...
class BaseAppSettings(BaseSettings):
    ...
    PATH_TO_DB: str = str(BASE_DIR / "database" / "source" / "cafe_service.db")
    ...
    S3_STORAGE_HOST: str = os.getenv("MINIO_HOST", "minio-cafe_service")
    ...
    S3_BUCKET_NAME: str = os.getenv("MINIO_STORAGE", "cafe_service-storage")
...
class TestingSettings(BaseAppSettings):
    ...
    def model_post_init(self, __context: dict[str, Any] | None = None) -> None:
        ...
        object.__setattr__(self, "EMAIL_HOST", os.getenv("EMAIL_HOST", "localhost"))
        object.__setattr__(self, "EMAIL_PORT", int(os.getenv("EMAIL_PORT", 1025)))
        object.__setattr__(self, "EMAIL_USE_TLS", False)
        object.__setattr__(self, "EMAIL_HOST_USER", "")
        object.__setattr__(self, "EMAIL_HOST_PASSWORD", "")
        object.__setattr__(self, "MAILHOG_API_PORT", int(os.getenv("MAILHOG_API_PORT", 8025)))
